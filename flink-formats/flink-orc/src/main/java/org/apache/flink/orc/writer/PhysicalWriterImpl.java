...
public class PhysicalWriterImpl implements PhysicalWriter {
    ...
    protected final OutStream compressStream;
    ...
    public PhysicalWriterImpl(FSDataOutputStream outputStream, OrcFile.WriterOptions opts)
            throws IOException {
        this(outputStream, opts, new WriterEncryptionVariant[0]);
    }
    ...
    private static class SizeCounters {
        long index = 0;
        long data = 0;
